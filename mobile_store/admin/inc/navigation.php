...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary bg-purple elevation-4 sidebar-no-expand">
        ...
        <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-transition os-host-scrollbar-horizontal-hidden">
          ...
          <div class="os-content-glue bg-dark" style="margin: 0px -8px; width: 249px; height: 646px;"></div>
          <div class="os-padding">
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content bg-dark" style="padding: 0px 8px; height: 100%; width: 100%;">
    ...
    $(document).ready(function(){
      ...
      $('.nav-link.active').addClass('bg-success')
    })
  </script>