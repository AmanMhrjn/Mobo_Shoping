                            ...
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <span id="esewa-button">
                                     <form action="https://uat.esewa.com.np/epay/main" method="POST">
                                        ...
                                        <input value="http://localhost/mobile_store/esewa/esewa_payment_success.php?q=su" type="hidden" name="su">
                                        <input value="http://localhost/mobile_store/esewa/esewa_payment_failed.php?q=fu" type="hidden" name="fu">
                                        <input type="image" src="image/esewa.png" width="100" height="40" >
                                    </form>
                                </span>
                            </div>
                        </div>
